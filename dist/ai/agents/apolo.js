...
async function runApoloAgent(message, context) {
    ...
    const tools = [
        ...
        { name: 'enviar_lista_enumerada', description: 'Exibir a lista de opções numerada (1-5).', parameters: { type: 'object', properties: {} }, function: async () => await (0, server_tools_1.sendEnumeratedList)() },
