...
exports.testarCNPJs = testarCNPJs;
...
async function testarCNPJs() {
    ...
    for (const cnpj of cnpjsParaTestar) {
        ...
        try {
            const resultado = await cnpj_service_1.cnpjService.consultarCNPJ(cnpj);
            if (resultado.success) {
                ...
                try {
                    ...
                    await (0, serpro_db_1.saveConsultation)(cleanCnpj, 'CNPJ_API', resultado.data, 200, 'test', leadId);
...
//# sourceMappingURL=test-cnpjs.js.map