...
export async function runApoloAgent(message: AgentMessage, context: AgentContext) {
    ...
    const tools: ToolDefinition[] = [
        ...
        { name: 'enviar_lista_enumerada', description: 'Exibir a lista de opções numerada (1-5).', parameters: { type: 'object', properties: {} }, function: async () => await sendEnumeratedList() },
